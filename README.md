...
- 热力图采用周日在上的 GitHub 式 7 行布局和蓝色色阶；零用量显示浅蓝，有用量按四档逐级加深。悬停、聚焦或触屏点击某天可查看日期、扣费、请求数和 Token。
